...
Navigate to the OpenBCI generated file, and click **OPEN**. The GUI will convert the file you selected. The resulting file will be placed inside a file called EEG_Data in the Processing OpenBCI GUI Sketch Folder. The file naming convention is **SDconverted-Year-Month-Day-Time.csv**. Example:

*Documents/Processing/OpenBCI_GUI/data/EEG_Data/SDconverted-2015-01-14_13-35-54.csv*

Remember that these samples are raw (un-averaged).  As per your hardware, review the Tutorial "OpenBCI Hardware / Data Format".
